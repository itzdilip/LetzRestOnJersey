 ...
 * 
 * @Provider public class JodiCloudExceptionMapper implements
 * ExceptionMapper<JodiCloudException> {
 * 
 * public JodiCloudExceptionMapper() {
 * System.out.println("JodiCloudExceptionMapper invoked!!!"); }
 * 
 * public Response toResponse(JodiCloudException exception) { System.out
 * .println("JodiCloudExceptionMapper " + exception.getMessage()); return
 * Response.status(500).entity(exception.getMessage()).build(); }
 * 
 * }
 */